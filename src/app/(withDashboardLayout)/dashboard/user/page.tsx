        ...
        <section className="p-5 space-y-5 flex flex-col justify-evenly  shadow-md shadow-[#f04336]">
          ...
          <article className="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
            <div className="flex items-center gap-4">
              <span className="hidden rounded-full bg-gray-100 p-2 text-black sm:block">
                <svg
                ...
                >
                  <g clipPath="url(#clip0_12_327)">
                    <path
                      d="M10.5937 22.5469C11.7587 22.5469 12.7031 21.6025 12.7031 20.4375C12.7031 19.2725 11.7587 18.3281 10.5937 18.3281C9.42871 18.3281 8.48431 19.2725 8.48431 20.4375C8.48431 21.6025 9.42871 22.5469 10.5937 22.5469Z"
                      fill="#0088FE"
                    />
                    <path
          ...
          <article className="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#FFBB28] uppercase font-bold">
                  Booking
                </p>
          ...
          <article className="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-green-500 uppercase font-bold">
                  Reviews
                </p>
          ...
          <article className="flex items-end justify-between rounded-lg border border-gray-100 bg-white p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#FF8042] font-bold uppercase">
                  Payment
                </p>
