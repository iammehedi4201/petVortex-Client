            ...
            <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex flex-wrap gap-4 mt-10">
                  <Link
                    type="button"
                    href={`/pets/${pet?.id}/adoption-request`}
                    className="min-w-[400px] text-center px-4 py-3 bg-[#f04336] hover:bg-[#111] text-white text-sm font-semibold rounded"
                  >
                    Adopt Now
                  </Link>
                </div>
            ...
            <div className="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
              ...
              <ul className="mt-6 space-y-6 text-[#333]">
                <li className="text-sm">
                  Species{" "}
                  <span className="ml-4 float-right">{pet?.species}</span>
                </li>
